...
df <- read_csv("Spanish_German.csv")
...
sample <- sample(seq(1,nrow(df)), size = 1000, replace = FALSE)

df <- df[sample, ]

write_csv(df, "Hartshorne_Spanish_German_subsmple.csv")
...
df %>% merge(df.qs, by.x = "question", by.y = "q") -> df
